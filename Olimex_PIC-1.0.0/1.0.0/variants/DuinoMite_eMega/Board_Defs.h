...
// SPP +
#define	_BOARD_NAME_	"DuinoMite_eMega"

#define  UEXT_EN_TRIS  TRISGbits.TRISG13
#define  UEXT_EN_LAT   LATGbits.LATG13

#define  UEXT_CS_TRIS  TRISDbits.TRISD14
#define  UEXT_CS_LAT   LATDbits.LATD14
...
*/
#define	_SPI_BASE		_SPI1A_BASE_ADDRESS
#define _SPI_ERR_IRQ	_SPI1A_ERR_IRQ
#define	_SPI_RX_IRQ		_SPI1A_RX_IRQ
#define	_SPI_TX_IRQ		_SPI1A_TX_IRQ
#define	_SPI_VECTOR		_SPI_1A_VECTOR
#define	_SPI_IPL_ISR	_SPI1A_IPL_ISR
